...
export default defineComponent({
  ...
  methods: {
    ...
    async getUserData () {
      this.userData = await JSON.parse(localStorage.getItem('userData')).user.name + ' ' + JSON.parse(localStorage.getItem('userData')).user.lastName
      console.log('GET USER DATA NAVBAR', this.userData)
